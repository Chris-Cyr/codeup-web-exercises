...
// if (numberYes === false) {
//     alert("No Number For You!");
// } else {
//     var number = Number(prompt("Please enter a number"));
//     var plusHundred = (number + 100);
//     if (!isNaN(number)) {
//         if (number % 2 == 0) {
...
//         }
//         alert("Your number plus 100 = " + plusHundred);
//         if (number < 0) {
...
//     }else{
//         return "That's not a defined color"
//     }
// }
...
//         break;
//     default:
//         alert ("That's not a defined color");
//         break;
//     }
// }
